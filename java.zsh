...
# alias java_ls='/usr/libexec/java_home -V 2>&1 | grep -Eo "^\s*\d+\.\d+\.\d+ " | cut -d , -f 1 | colrm 1 4 | grep -v Home'
...
# Function: Switch between Java versions on the fly
# Ex: java_use 1.8
function java_use() {
...
# echo "[loaded:java] java_ls, java_use"
